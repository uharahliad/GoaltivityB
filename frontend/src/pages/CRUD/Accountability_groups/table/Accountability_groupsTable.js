...
import * as dataFormat from 'pages/CRUD/Accountability_groups/table/Accountability_groupsDataFormatters';
...
const Accountability_groupsTable = () => {
          ...
          <LinkMaterial
            ...
            href={
              process.env.NODE_ENV === 'production'
                ? window.location.origin + '/api-docs/#/Accountability_groups'
                : 'http://localhost:8080/api-docs/#/Accountability_groups'
            }
          >
            API documentation for accountability_groups
          </LinkMaterial>
        </div>
      </Widget>
