module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('messages', 'groupId', { transaction });

      await queryInterface.removeColumn('messages', 'authorId', {
        transaction,
      });

      await queryInterface.removeColumn('messages', 'text', { transaction });

      await queryInterface.removeColumn('accountability_groups', 'name', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('action_items', 'goalId', {
        transaction,
      });

      await queryInterface.removeColumn('action_items', 'name', {
        transaction,
      });

      await queryInterface.removeColumn('success_criteria', 'goalId', {
        transaction,
      });

      await queryInterface.removeColumn('success_criteria', 'name', {
        transaction,
      });

      await queryInterface.removeColumn('goal_categories', 'name', {
        transaction,
      });

      await queryInterface.removeColumn('goals', 'authorId', { transaction });
      ...
      await queryInterface.dropTable('accountability_groups', { transaction });

      await queryInterface.dropTable('action_items', { transaction });

      await queryInterface.dropTable('success_criteria', { transaction });

      await queryInterface.dropTable('goal_categories', { transaction });
